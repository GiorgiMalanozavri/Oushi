...
**A personal AI brain — an AI that actually knows you.** [oushi.app](https://oushi.app)

Oushi reads your Google life (Gmail first) and surfaces only the things that actually need you, so the "oh shit, I forgot" moments get caught before you have them.
...
See `.env.example` for the required keys (Supabase, Google OAuth / Pub/Sub, Anthropic, Resend).
